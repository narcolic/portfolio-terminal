    ...
    <TerminalTable variant="panel" className="font-mono text-[11px]">
      <thead className="bg-secondary/40 text-[10px] uppercase tracking-[0.2em] text-muted-foreground">
        <tr>
          ...
          <th className="px-3 py-2 text-right">JOBS COUNT</th>
          ...
          visits.map((visit) => {
            ...
            const sortedJobs = [...visit.jobs].sort((a, b) => {
              ...
              switch (sort.key) {
                ...
                case "category":
                  return (a.category_snapshot ?? "").localeCompare(b.category_snapshot ?? "") * dir;
                case "qty":
                ...
                case "total": {
                  const aTotal = Number(a.line_total_ex_vat) * (1 + Number(visit.vat_rate));
                  const bTotal = Number(b.line_total_ex_vat) * (1 + Number(visit.vat_rate));
            ...
            return (
              <Fragment key={visit.id}>
                ...
                >
                  ...
                  <td className="px-3 py-2 text-right">{visit.jobs.length} jobs</td>
